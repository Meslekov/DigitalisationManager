...
{
    /// <inheritdoc />
    public partial class InitialPlusCustomIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "44444444-4444-4444-4444-444444444444", "Administrator", "Administrator", "ADMINISTRATOR" },
                    { new Guid("22222222-2222-2222-2222-222222222222"), "55555555-5555-5555-5555-555555555555", "User", "User", "USER" }
                });
